    ...
    function v(e, t) {
        ...
        function n(e) {
            function r() {
                ...
                t = void 0,
                o = void 0;
                if (b.container) if (b.container instanceof Object) t = (e = H({},
                e, b.container)).width - e.left - e.right - 2 * b.margin,
            ...
            return new a(function(t) {
                if (d && -1 === c.indexOf(d)) t(f);
                    ...
                    if (E.zoomed) t(f);
                        ...
                        }), E.original.classList.add("medium-zoom-image--hidden"), E.zoomed.classList.add("medium-zoom-image--opened"), E.zoomed.addEventListener("click", m), E.zoomed.addEventListener("transitionend",
                        function e() {
                            l = !1,
                            E.zoomed.removeEventListener("transitionend", e),
                            E.original.dispatchEvent(g("medium-zoom:opened", {
                                detail: {
                                    zoom: f
                                }
                            })),
                            ...
                            E.zoomedHd = E.zoomed.cloneNode(),
                            E.zoomedHd.removeAttribute("sizes");
                            var i = E.zoomedHd.addEventListener("load",
                            function() {
        ...
        m = function() {
            return new a(function(t) {
                if (!l && E.original) {
                    ...
                    E.original.dispatchEvent(g("medium-zoom:close", {
                        detail: {
                            zoom: f
                        }
                    })),
                    ...
                    function e() {
                        ...
                        l = !1,
                        E.zoomed.removeEventListener("transitionend", e),
                        E.original.dispatchEvent(g("medium-zoom:closed", {
                            detail: {
                                zoom: f
                            }
                        })),
        ...
        var f = {
            ...
            update: function(e) {
                ...
                o = t;
                if (t.background && (s.style.background = t.background), t.container && t.container instanceof Object && (o.container = H({},
                b.container, t.container)), t.template) {
            ...
            clone: function(e) {
                return v(H({},
                b, 0 < arguments.length && void 0 !== e ? e: {}))
            },
            attach: o,
            detach: function() {
                for (var e = arguments,
                ...
                return i.forEach(function(e) {
                    ...
                    e.dispatchEvent(g("medium-zoom:detach", {
                        detail: {
                            zoom: f
                        }
                    }))
