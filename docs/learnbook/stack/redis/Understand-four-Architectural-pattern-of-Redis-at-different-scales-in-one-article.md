...
![](../../stack/redis/_assets/Pasted%20image%2020230713100331.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100355.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100411.png)

但是，数据持久化具体应该怎么做呢？

我猜你最容易想到的一个方案是，Redis 每一次执行写操作，除了写内存之外，同时也写一份到磁盘上，就像这样：

![](../../stack/redis/_assets/Pasted%20image%2020230713100422.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100436.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100449.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100504.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100517.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100529.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100543.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100641.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100654.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100707.png)

有了这个方案，就不需要人去介入处理了，一切就变得自动化了，是不是很爽？

但这里还有一个问题，如果 master 状态正常，但这个哨兵在询问 master 时，它们之间的网络发生了问题，那这个哨兵可能会「**误判**」。

![](../../stack/redis/_assets/Pasted%20image%2020230713100719.png)

这个问题怎么解决？

既然一个哨兵会误判，那我们可以部署多个哨兵，让它们分布在不同的机器上，让它们一起监测 master 的状态，流程就变成了这样：

![](../../stack/redis/_assets/Pasted%20image%2020230713100730.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100752.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100807.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100820.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100832.png)
...
![](../../stack/redis/_assets/Pasted%20image%2020230713100845.png)
