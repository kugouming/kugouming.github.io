...
![](../statics/images/fucking-algorithm/pictures/session/1.png)

在这之后，浏览器的请求中的 `Cookie` 字段就带上了这两个 cookie：

![](../statics/images/fucking-algorithm/pictures/session/2.png)
...
![http://www.editthiscookie.com/](../statics/images/fucking-algorithm/pictures/session/3.png)
...
![](../statics/images/fucking-algorithm/pictures/session/4.jpg)
