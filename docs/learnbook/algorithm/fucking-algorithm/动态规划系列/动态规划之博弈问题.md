...
![1](../statics/images/fucking-algorithm/pictures/博弈问题/1.png)
...
![2](../statics/images/fucking-algorithm/pictures/博弈问题/2.png)

这里需要注意一点，我们发现 base case 是斜着的，而且我们推算 dp[i][j] 时需要用到 dp[i+1][j] 和 dp[i][j-1]：

![3](../statics/images/fucking-algorithm/pictures/博弈问题/3.png)

所以说算法不能简单的一行一行遍历 dp 数组，**而要斜着遍历数组：**

![4](../statics/images/fucking-algorithm/pictures/博弈问题/4.png)
