...
![](../statics/images/fucking-algorithm/pictures/kgroup/title.png)
...
![](../statics/images/fucking-algorithm/pictures/kgroup/1.jpg)

如果我设法把前 2 个节点反转，那么后面的那些节点怎么处理？后面的这些节点也是一条链表，而且规模（长度）比原来这条链表小，这就叫**子问题**。

![](../statics/images/fucking-algorithm/pictures/kgroup/2.jpg)
...
![](../statics/images/fucking-algorithm/pictures/kgroup/3.jpg)

**2、将第 `k + 1` 个元素作为 `head` 递归调用 `reverseKGroup` 函数**。

![](../statics/images/fucking-algorithm/pictures/kgroup/4.jpg)

**3、将上述两个过程的结果连接起来**。

![](../statics/images/fucking-algorithm/pictures/kgroup/5.jpg)
...
![](../statics/images/fucking-algorithm/pictures/kgroup/8.gif)
...
![](../statics/images/fucking-algorithm/pictures/kgroup/6.jpg)

递归部分就不展开了，整个函数递归完成之后就是这个结果，完全符合题意：

![](../statics/images/fucking-algorithm/pictures/kgroup/7.jpg)
