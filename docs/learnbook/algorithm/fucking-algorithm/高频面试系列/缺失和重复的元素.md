...
![](../statics/images/fucking-algorithm/pictures/dupmissing/1.gif)

如果出现重复元素 `4`，直观结果就是，索引 `4` 所对应的元素已经是负数了：

![](../statics/images/fucking-algorithm/pictures/dupmissing/2.jpg)

对于缺失元素 `3`，直观结果就是，索引 `3` 所对应的元素是正数：

![](../statics/images/fucking-algorithm/pictures/dupmissing/3.jpg)
