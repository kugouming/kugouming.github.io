...
![](../statics/images/fucking-algorithm/pictures/正则/1.jpeg)

将 `i` 加 1，`j` 不变，含义就是 `p[j]` 匹配了 `s[i]`，但 `p[j]` 还可以继续匹配，即通配符匹配多次的情况：

![](../statics/images/fucking-algorithm/pictures/正则/2.jpeg)
...
![](../statics/images/fucking-algorithm/pictures/正则/3.jpeg)
...
![](../statics/images/fucking-algorithm/pictures/正则/4.jpeg)
