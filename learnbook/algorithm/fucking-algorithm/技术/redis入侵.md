...
![](../statics/images/fucking-algorithm/pictures/redis入侵/1.png)

但是，我发现自己竟然可以直接访问 Redis：

![](../statics/images/fucking-algorithm/pictures/redis入侵/2.png)
...
![](../statics/images/fucking-algorithm/pictures/redis入侵/3.png)

命令 Redis 把生成的数据文件保存到 `/root/.ssh/` 中的 `authored_keys` 文件中：

![](../statics/images/fucking-algorithm/pictures/redis入侵/4.png)

现在，root 的家目录中已经包含了我们的 RSA 公钥，我们现在可以通过密钥对登录进 root 了：

![](../statics/images/fucking-algorithm/pictures/redis入侵/5.png)

看一下刚才写入 root 家的公钥：

![](../statics/images/fucking-algorithm/pictures/redis入侵/6.png)
