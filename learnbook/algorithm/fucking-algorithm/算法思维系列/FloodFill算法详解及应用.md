...
![floodfill](../statics/images/fucking-algorithm/pictures/floodfill/floodfill.gif)

这种算法思想还在许多其他地方有应用。比如说扫雷游戏，有时候你点一个方格，会一下子展开一片区域，这个展开过程，就是 FloodFill 算法实现的。

![扫雷](../statics/images/fucking-algorithm/pictures/floodfill/扫雷.png)

类似的，像消消乐这类游戏，相同方块积累到一定数量，就全部消除，也是 FloodFill 算法的功劳。

![xiaoxiaole](../statics/images/fucking-algorithm/pictures/floodfill/xiaoxiaole.jpg)
...
![title](../statics/images/fucking-algorithm/pictures/floodfill/leetcode.png)
...
![ppt1](../statics/images/fucking-algorithm/pictures/floodfill/ppt1.PNG)
...
if (image[x][y] != origColor) return;
```
![ppt2](../statics/images/fucking-algorithm/pictures/floodfill/ppt2.PNG)

但是，如果说 origColor 和 newColor 一样，这个 if 语句就无法让 fill(1, 1)* 正确退出，而是开启了下面的重复递归，形成了死循环。

![ppt3](../statics/images/fucking-algorithm/pictures/floodfill/ppt3.PNG)
...
![抠图](../statics/images/fucking-algorithm/pictures/floodfill/抠图.jpg)
...
![ppt4](../statics/images/fucking-algorithm/pictures/floodfill/ppt4.PNG)
...
![](../statics/images/fucking-algorithm/pictures/floodfill/ppt5.PNG)
