...
(t = function() {
	...
	function b(e) {
		return null == e ? (void 0 === e ? '[object Undefined]' : '[object Null]') : Object.prototype.toString.call(
			e);
	}
	var x = function(e) {
			...
			t(
				t(
					t({}, {
						...
						shouldSort: !0,
						sortFn: function(e, t) {
							return e.score === t.score ? (e.idx < t.idx ? -1 : 1) : e.score < t.score ? -1 :
								1;
						},
					}, ), {
						includeMatches: !1,
	...
	var $ = (function() {
		function e() {
			...
			r(this, e), (this.norm = E(c, 3)), (this.getFn = i), (this.isCreated = !1), this
				.setIndexRecords();
		}
		return (
			o(e, [{
								...
								y = (function(e, t, n) {
									...
									for (
										...
										if (((x = Math.min(O, x)), (L = m + k), S))
											for (var j = 0; j < k;)(_[m + j] = 1), (
												j += 1);
									}
									L = -1;
									for (var A = [], C = 1, E = k + M, $ = 1 << (k -
											1), F = 0; F < k; F += 1) {
										for (var W = 0, T = E; W < T;)
											R(t, {
												errors: F,
	...
	var ye = (function() {
		...
		return (
			o(e, [{
					key: 'setCollection',
					value: function(e, t) {
						if (((this._docs = e), t && !(t instanceof $))) throw new Error(
